<script lang="ts">
	let { mode = 'idle' }: { mode?: 'idle' | 'listening' | 'thinking' | 'speaking' } = $props();
</script>

<div
	class="flex h-[200px] w-full flex-col items-center justify-center gap-4 transition-all duration-300"
	data-mode={mode}
>
